---
title: Collections & Recently Played
group: Games
order: 4
icon: ⭐
...
1. Highlight a game and press the Options button.
2. Choose **Add to Collection**.
3. Create a new collection (type a name with the keyboard) or pick an existing one.
...
For the full list of Options-menu actions on games and collections, see [Context Menus](context-menus.html).
...
- [Context Menus](context-menus.html) for every Options-menu action.
- [Adding Games](adding-games.html) for building your library.
